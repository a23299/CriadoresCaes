...
namespace CriadoresDeCaes.Controllers
{
    public class CriadoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,NomeCriador,Morada,CodPostal,Email,Telemovel")] Criadores criadores)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,NomeCriador,Morada,CodPostal,Email,Telemovel")] Criadores criadores)
        {
            if (id != criadores.Id)
            {
                return NotFound();
